  ...
  if ($.fn.DataTable) {
    ...
    $(document).ready(function () {
      if ($('[data-toggle="data-table1"]').length) {
        var table = $('[data-toggle="data-table1"]').DataTable({
          "autoWidth": false,
          "dom": '<"row align-items-center gy-2"<"" ><""f>><"table-responsive my-3 mx-4" rt><"row align-items-center" <"col-md-6" i><"col-md-6" p>><"clear">',
          buttons: []
        });

        // Hide the entries and filter labels
        ...
        // Wrap the search bar in a new div and move the button to another col-md-6
        var searchWrapper = $('<div class="row align-items-center gy-2"><div class="col-md-6  dataTables_filter  custom"></div><div class="col-md-6 d-flex justify-content-md-end justify-content-center"></div></div>');
        $('.dataTables_filter').before(searchWrapper);
        searchWrapper.find('.col-md-6.dataTables_filter').append($('.dataTables_filter '));
        searchWrapper.find('.col-md-6.d-flex').append('<div class="d-flex gap-2"><a href="" class="mx-3">Print</a> <a href="" class="mx-3">Excel</a> <a href="" class="mx-3">Pdf</a></div>');
